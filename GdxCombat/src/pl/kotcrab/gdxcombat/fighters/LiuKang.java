...
public class LiuKang extends AbstractFighter {
	...
	public LiuKang(boolean isPlayer) {
		super(isPlayer);
		...
		stanceAnim = new Animation(0.1f, AnimationUtils.loadAnim(atlas, "stance", 8, isPlayer));
		...
		duckAnim = new Animation(0.1f, AnimationUtils.loadAnim(atlas, "duck", 3, isPlayer));
		punchAnim = new Animation(0.1f, AnimationUtils.loadAnim(atlas, "punch", 7, isPlayer));
		kickAnim = new Animation(0.1f, AnimationUtils.loadAnim(atlas, "kick", 5, isPlayer));
		hitAnim = new Animation(0.1f, AnimationUtils.loadAnim(atlas, "hit", 3, isPlayer));
		winAnim = new Animation(0.1f, AnimationUtils.loadAnim(atlas, "win", 15, isPlayer));
		loseAnim = new Animation(0.1f, AnimationUtils.loadAnim(atlas, "lose", 8, isPlayer));
